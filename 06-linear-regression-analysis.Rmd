...
```{r simple-regression-example, eval=FALSE}
...
```{r multiple-regression-example, eval=FALSE}
# Load required packages
library(tidyverse)
...
```{r polynomial-regression-example, eval=FALSE}
...
```{r log-transformation-example, eval=FALSE}
