...
```{r ttest, echo = FALSE, fig.cap = "The t.test vademecum"}
knitr::include_graphics("images/wf_test.png")
```
...
```
what we conclude? we conclude that:  `r report(test_for_wider_format)`
